        ...
        <>
            ...
            <div className=" container mx-auto relative md:top-[350px] px-4 top-6 min-h-screen md:mb-[450px] mb-20">
                <section className="grid md:grid-cols-2 gap-6 grid-cols-1 min-h-fit ">
                    <div className="border rounded-sm shadow-sm px-8 py-4 ">
                    ...
                    <div className="border rounded-sm shadow-sm px-8 py-4 ">
                        <h2 className="text-2xl font-bold"><span ><img className="w-10 h-10" src="https://i.ibb.co/XpGFZf5/sweets.png" alt="" /></span>Snacks</h2>
                        <ul className="p-4">
