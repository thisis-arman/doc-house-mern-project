    ...
    <section>
      ...
      <section>
        <section className="text-gray-600 body-font overflow-hidden">
          <div className="container px-5 py-24 relative top-[400px] mb-[400px] mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap shadow-md p-6">
              <img
                alt="doctor"
        ...
        {/* Overview Section */}
        <section className="text-gray-600 body-font overflow-hidden ">
          <div className="container px-5 pb-24 mx-auto shadow-xl">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              <div className=" w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                ...
                <div className="flex mb-4">
                   ...
                   <div className="flex  ">
                   <Tab className='border w-1/3 mr-4 hover:bg-gray-300 '>Overview</Tab>
                      <Tab className='w-1/3 border hover:bg-gray-300 mr-4'>Locations</Tab>
                      <Tab className='w-1/3 border hover:bg-gray-300 mr-4'>Reviews</Tab>
                      <Tab className='w-1/3 border hover:bg-gray-300 mr-4'>Business Hours</Tab>
                   </div>
                    </TabList>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2  ">
                      ...
                      <div>
                        ...
                        <p className="py-4">
                          <li className="text-md font-bold ">{education[2]?.institution}</li>
                      ...
                      <div>
                        ...
                        <div className="pl-6">
                        {
                          awards.map((data,i)=><p className="py-2" key={i}>
                            <h3 className="font-bold list-item text-md">{data.awardName}</h3>
