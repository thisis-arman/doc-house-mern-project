            ...
            <section className=" body-font">
                <div className="container mx-auto flex px-5 py-4 md:flex-row flex-col justify-center items-center">
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                        <h1 className="title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900">Our one billion mission
                            <br className="hidden lg:inline-block" />sounds bold, We agree.
                        </h1>
