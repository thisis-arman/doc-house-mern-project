        ...
        <div>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-12 mx-auto">
                    ...
                    <div className="grid md:grid-cols-4 grid-cols-1 gap-4 sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                        <div className="p-4 border shadow-md  flex flex-col text-center items-center">
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. </p>
