                            ...
                            <form onSubmit={handleForm} action="#" className="mt-8 grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        id="LastName"
                                        name="email"
                                        className="mt-1 w-full rounded-md border-gray-200 p-2 border-2  bg-white text-sm text-gray-700 shadow-sm"
                                    />
                                </div>
                                ...
                                <div className="col-span-6">
                                    ...
                                    <input
                                        ...
                                        id="Email"
                                        name="image"
                                        className="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 p-2 border-2 shadow-sm"
                                    />
                                </div>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    ...
                                    <input
                                        ...
                                        id="Password"
                                        name="password"
                                        className="mt-1 w-full rounded-md p-2 border-2 border-gray-200 bg-white text-sm text-gray-700 shadow-sm"
                                    />
                                    <span >
                                        <PiEyeClosedThin className='relative -top-7 hover:bg-base-200 p-1 w-6 rounded-md h-6 left-52' />
                                    </span>
                                </div>
