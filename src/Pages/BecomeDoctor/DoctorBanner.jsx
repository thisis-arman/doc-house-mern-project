...
const DoctorBanner = () => {
    return (
        <div className="container mx-auto ">
            <section className="text-gray-600 body-font  relative md:top-[300px]  top-6 py-24 md:py-12 md:mb-[250px]">
                <div className="container mx-auto flex px-5 py-4  md:flex-row gap-8 flex-col-reverse justify-center items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col items-center md:text-left md:mb-16 mb-0 md:items-start text-center">
