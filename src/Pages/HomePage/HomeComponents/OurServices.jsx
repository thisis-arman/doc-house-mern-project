...
const OurServices = () => {
  useEffect(() => {
    ...
    return (
        <div className="container relative md:top-[600px] top-[550px] mb-[400px] md:mb-[500px]  w-full mx-auto grid md:grid-cols-2 gap-4 px-5 py-24 md:flex-row flex-col items-center">
