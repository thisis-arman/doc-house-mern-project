...
const HeroSection = () => {
  ...
  <div  className="container mx-auto flex px-5 md:py-24  py-44  md:flex-row flex-col items-center">
    <div data-aos="fade-left" data-aos-delay="800"  className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      <h1 className="title-font sm:text-6xl text-5xl mb-4 font-medium ">Your Best Medical 
