    ...
    <div>
      ...
      <section className=" body-font">
        <div className="container px-5 md:py-12 mx-auto">
          <h1 className="text-3xl sm:text-5xl font-medium title-font  mb-12 text-center">Testimonials</h1>
          {/*  <div className="flex flex-wrap -m-4">
            <div className="p-4 md:md:w-1/2 w-full">
              <div className="h-full  border shadow-md p-8 rounded">
              ...
              <div className="p-4 md:w-1/2 mx-auto">
                <div className="h-full  border shadow-md p-8 rounded">
                  ...
                  <a className="inline-flex items-center">
                    ...
                    <span className="flex-grow flex flex-col pl-4">
                      <span className="title-font font-medium  ">Alex flyed</span>
                      <span className="text-gray-500 text-sm">UI DEVELOPER</span>
                    </span>
                  </a>
                </div>
              ...
              <div className="p-4 md:w-1/2 mx-auto">
                <div className="h-full  border shadow-md p-8 rounded">
                  ...
                  <a className="inline-flex items-center">
                    ...
                    <span className="flex-grow flex flex-col pl-4">
                      <span className="title-font font-medium  ">Taskia Ahmed</span>
